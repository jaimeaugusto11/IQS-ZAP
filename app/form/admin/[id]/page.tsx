...
// Editar inquérito + estatísticas/resumo
// ------------------------------------------
"use client";
...
// NOVO: secção de estatísticas
import { SurveyStatsSection } from "@/components/iqs/SurveyStatsSection";
  ...
  return (
    <main className="mx-auto max-w-5xl p-6 space-y-6">
      <Tabs defaultValue="form">
        ...
        {/* Aba de configuração (o teu formulário original) */}
        ...
        {/* Aba de estatísticas: taxa de resposta, downloads, Automation */}
        <TabsContent value="stats">
          <SurveyStatsSection surveyId={id} />
        </TabsContent>
      </Tabs>
    </main>
  );
